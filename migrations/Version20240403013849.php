 ...
 */
final class Version20240403013849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce_materiel CHANGE mode mode VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce_materiel CHANGE mode mode VARCHAR(255) NOT NULL');
