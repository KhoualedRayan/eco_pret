 ...
 */
final class Version20240210213935 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce_materiel ADD CONSTRAINT FK_559ABE53BA29911A FOREIGN KEY (posteur_id_id) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE annonce_service ADD CONSTRAINT FK_1BF200B2BA29911A FOREIGN KEY (posteur_id_id) REFERENCES user (id)');
