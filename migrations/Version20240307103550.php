 ...
 */
final class Version20240307103550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD CONSTRAINT FK_723705D19DDC44B3 FOREIGN KEY (posteur_id) REFERENCES user (id)');
